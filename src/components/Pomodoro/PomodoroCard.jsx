...
export default function Pomodoro() {
  ...
  const pauseTimer = () => {
    setIsRunning(false);
    elapsedRef.current = focusTime * 60 - timeLeft; // store elapsed time
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-gray-100">
      {!showSettings && (
        <div className="relative flex w-[480px] max-w-full flex-col items-center rounded-xl bg-white p-8 shadow-2xl">
          {/* Settings Icon */}
          <div
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={resetTimer}
              className="rounded-xl bg-white px-6 py-3 text-2xl text-black shadow-md transition-colors hover:bg-gray-100"
            >
              Reset
            </button>
          </div>
